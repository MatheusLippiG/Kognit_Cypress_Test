describe('Home Page do Kognit', () => {
  ...
  it('Ao clicar no botão "Kognit", deve recarregar a home page', () => {
    cy.wait(1000);
    cy.get('a[href="/"] img[alt="Kognit"]').click();
    cy.title().should('eq', 'Kognit – are you ready to make change?');
  });

  it('Ao clicar nos botões Atuação Global, Serviços e Clientes, deve ser direcionado a cada painel correspondente', () => {
  ...
  it('Ao clicar no botão CONTATO, deve ser direcionado para a página de contato', () => {
  ...
  it('Ao clicar nas setas de próximo e anterior, na primeira imagem do site, deve mudar o painel para frente e para trás', () => {
  ...
  it('Ao clicar no botão ENTRE EM CONTATO, deve ser direcionado para a página de contato', () => {
  ...
  it('Ao clicar nos botões HOME, ATUAÇÃO GLOBAL, SERVIÇOS e CLIENTES no menu do rodapé, deve ser direcionado para seu painel correspondente', () => {
